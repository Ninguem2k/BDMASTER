...
begin
  ...
  try
    ...
    // Verifica se o DataSource do DBGrid está atribuído
    if Grid.DataSource = nil then
    begin
      ShowMessage('O DataSource do DBGrid não foi configurado corretamente.');
      Exit;
    end;
    ...
    // Observação: Não chamamos Query.Free, pois ele está vinculado ao DataSource
  except
    on E: Exception do
    begin
